...
Все модули устанавливаются через HACS. [Вначале установите HACS](https://github.com/LanKing/ha-tools/blob/main/appendix-what-is-hacs/docs/README_ru.md) если его у вас нет. Это вообще база для Home Assistant, которая наверняка понадобится вам ещё много раз.
