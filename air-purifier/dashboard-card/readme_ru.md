...
Все модули устанавливаются через [HACS](#what-is-hacs). [Установите вначале HACS](#what-is-hacs) если его у вас нет. Это вообще база для Home Assistant, которая наверняка понадобится вам ещё много раз.
